        ...
        <div className="col-span-12 lg:col-span-5">
          <div className="relative bg-surface/60 border border-border p-1 cyan-glow-strong overflow-hidden">
            <div ref={frameRef} className="relative bg-background border border-border aspect-[3/4] lg:aspect-[4/5] overflow-hidden">
              <video
                ref={videoRef}
                src="https://d8j0ntlcm91z4.cloudfront.net/generated-videos/d8a51f3d-8fa2-46e3-9f82-1a89c8e1c4e0.mp4"
                autoPlay
                muted
                loop
                playsInline
                ...
                style={{ objectPosition: "70% 30%", transform: "scale(1.1)", transformOrigin: "50% 30%" }}
              />
              {/* Cursor-tracking pupils overlaid on the robot's eyes */}
              <div
                ref={leftPupilRef}
                ...
                style={{
                  ...
                  boxShadow: "0 0 12px hsl(var(--primary)), 0 0 24px hsl(var(--primary) / 0.7)",
                  mixBlendMode: "screen",
                }}
              />
              <div
